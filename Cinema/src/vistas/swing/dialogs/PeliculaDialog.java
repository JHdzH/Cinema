        ...
        try {
            if (pelicula == null) {
                ...
                if (success) {
                    ...
                    JOptionPane.showMessageDialog(this, "Error al agregar película", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                ...
                boolean success = controller.actualizarPelicula(pelicula);
                if (success) {
                    JOptionPane.showMessageDialog(this, "Película actualizada exitosamente");
                    dispose();
                } else {
                    JOptionPane.showMessageDialog(this, "Error al actualizar película", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        } catch (Exception e) {
